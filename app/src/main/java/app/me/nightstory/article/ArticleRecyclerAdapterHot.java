...
public class ArticleRecyclerAdapterHot extends FirestoreRecyclerAdapter<ArticlePostModel, ArticleViewHolder> {
    ...
    private final Boolean[] likeChecked = {false};

    public ArticleRecyclerAdapterHot(FirestoreRecyclerOptions recyclerOptions) {
